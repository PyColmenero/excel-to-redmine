...
//         console.log(this.inputHeaderTool.checked);
...
//                 table[x][z].textColor = "";
//                 table[x][z].bgColor = "";
//                 // if (table[x][z].textColorVirgen) {
//                 //     if (table[x][z].textColor === "#fff") {
//                 //         table[x][z].textColor = ""
//                 //     } else if (table[x][z].textColor === "") {
//                 //         table[x][z].textColor = "#fff";
//                 //     }
//                 // }
//             }
//         } else if (this.inputTextColorTool.checked) {
...
//                     <DragFileHere visibility={this.state.dragFileVisibility} supports={this.allowedExtensions} />
//                     <Loading visibility={this.state.loadingVisibility} />
//                     <ExcelTable tableName={this.state.excelFilename}
//                         tableSize={this.state.tableSize}
//                         tableArray={this.state.excel2DArray}
//                         visibility={this.state.excelTableVisibility}
//                         setNothing={this.setNothing}
//                         // inputTextTool={this.state.inputTextTool}
