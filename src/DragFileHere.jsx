...
export class DragFileHere extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        return (
            <div id="dragFileHere" className={this.props.visibility}>
                <div className='text-center'>
                    ...
                    <h1 className='mb-0'>Drag your Excel here...</h1>
                    <p className='m-0 mb-1 fs-5'>or <span className="link-primary" >browse</span></p>
                    <p id="supports">Supports: {this.props.supports.join(", ")}</p>
                </div>
            </div>
        )
    }
